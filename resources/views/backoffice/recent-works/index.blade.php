            ...
            <div class="container-fluid px-[0.625rem]">
                ...
                <div class="grid grid-cols-1 mb-5">
                    <div class="flex items-center justify-between">
                        <h4 class="mb-sm-0 text-lg font-semibold grow text-gray-800 dark:text-gray-100">Recent Work List
                        </h4>
                ...
                <div class="card dark:bg-zinc-800 dark:border-zinc-600">
                    <div class="card-body">
                        <div class="pb-4 bg-white dark:bg-transparent flex justify-between">
                            ...
                            <div class="">
                                <a href="{{ route('recent-works.create') }}">
                                    <button type="button"
                                        class="btn text-white bg-green-500 border-green-500 hover:bg-green-600 hover:border-green-600 focus:bg-green-600 focus:border-green-600 focus:ring focus:ring-green-500/30 active:bg-green-600 active:border-green-600"><i
                                            ...
                                            class="align-middle">{{ __('Create Recent Work') }}</span></button>
                                </a>
                            </div>
                        </div>
                        <div class="relative overflow-x-auto mb-2">
                            <table class="w-full text-sm text-left text-gray-500 ">
                                ...
                                <tbody>
                                    @forelse ($recentWorks as $recentWork)
                                        <tr
                                            ...
                                            <td class="px-6 py-3.5 dark:text-zinc-100 flex justify-items-start">
                                                <div class="dropstart text-end relative">
                                                    ...
                                                    <ul class=" dropdown-menu min-w-max absolute bg-white z-50 float-left py-2 list-none text-left -right-10 top-6 w-40
                                                        ...
                                                        <li>
                                                            <form method="POST"
                                                                action="{{ route('recent-works.destroy', $recentWork->id) }}">
                                                                @csrf
                                                            ...
                                                            bg-transparent text-gray-700 dark:text-gray-100 hover:bg-gray-50/50 dark:hover:bg-zinc-600/50"
                                                                    style="text-align: left"><i
                                                                        class="fas fa-light fa-circle-minus px-1"></i>{{ __('Delete') }}</button>
                                                            </form>
                                                        </li>
                                                    </ul>
                                                </div>
                                    ...
                                    @empty
                                        <tr>
                                            <td colspan="9" class="text-center dark:text-zinc-100">
