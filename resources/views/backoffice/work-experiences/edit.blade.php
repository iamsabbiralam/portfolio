                                ...
                                <div class="col-span-12 lg:col-span-6">
                                    <div class="mb-4">
                                        <label for="example-text-input"
                                            class="block font-medium text-gray-700 dark:text-gray-100 mb-2">Start
                                            Date</label>
                                        <input
                                    ...
                                    <div class="mb-4">
                                        <label for="example-text-input"
                                            class="block font-medium text-gray-700 dark:text-gray-100 mb-2">Designation</label>
                                        <input
                                            ...
                                            type="text" value="{{ $workExperience->designation }}"
                                            name="designation" id="example-text-input">
                                    </div>
                                    <div class="mb-4">
                                        <label for="example-text-input"
                                            class="block font-medium text-gray-700 dark:text-gray-100 mb-2">Company
                                            Name</label>
                                        <input
                                            ...
                                            value="{{ $workExperience->company_name }}" id="example-text-input">
                                    </div>
                                    <div class="mb-4">
                                        <label for="example-text-input"
                                            class="block font-medium text-gray-700 dark:text-gray-100 mb-2">City</label>
                                        <input
                                            class="w-full rounded border-gray-100 py-2.5 text-sm text-gray-500 focus:border focus:border-violet-500 focus:ring-0 dark:bg-zinc-700/50 dark:border-zinc-600 dark:text-zinc-100/60"
                                            type="city" value="{{ $workExperience->city_name }}" name="city_name"
                                            id="example-city-input">
                                    </div>
                                    <div class="mb-4">
                                        <label for="example-text-input"
                                            class="block font-medium text-gray-700 dark:text-gray-100 mb-2">Website</label>
                                        <input
                                            class="w-full rounded border-gray-100 py-2.5 text-sm text-gray-500 focus:border focus:border-violet-500 focus:ring-0 dark:bg-zinc-700/50 dark:border-zinc-600 dark:text-zinc-100/60"
                                            type="website" value="{{ $workExperience->website }}" name="website"
                                            id="example-website-input">
                                    </div>
                                </div>
                                <div class="col-span-12 lg:col-span-6">
                                    <div class="mb-4">
                                        <label for="example-text-input"
                                            class="block font-medium text-gray-700 dark:text-gray-100 mb-2">End
                                            Date</label>
                                        <input
                                            class="w-full rounded border-gray-100 placeholder:text-sm focus:border focus:border-violet-500 focus:ring-0 dark:bg-zinc-700/50 dark:border-zinc-600 dark:text-zinc-100/60"
                                    ...
                                    <div class="mb-4">
                                        <label for="example-logo-input"
                                            class="block font-medium text-gray-700 dark:text-zinc-100 mb-2">Logo</label>
                                        <input
                                            class="w-full rounded border-gray-100 py-2.5 text-sm text-gray-500 focus:border focus:border-violet-500 focus:ring-0 dark:bg-zinc-700/50 dark:border-zinc-600 dark:text-zinc-100/60"
                                            type="file" name="logo"
                                            value="{{ old('logo', isset($workExperience->logo) ? $workExperience->logo : '') }}"
                                            id="example-logo-input">
                                    </div>
                                </div>
                            </div>
